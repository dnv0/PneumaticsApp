...
public class RopeControllerSimple : MonoBehaviour
{
    ...
    //{
    //    get => whatIsHangingFromTheRope;
    //    set
    //    {
    //        whatIsHangingFromTheRope = PointA;
    //    }
    //}
    //public Transform PointB
    //{
    //    get => whatTheRopeIsConnectedTo;
    //    set
    //    {
    //        whatTheRopeIsConnectedTo = PointB;
    //    }
    //}
    ...
    void Update()
    {
        whatTheRopeIsConnectedTo.position = Camera.main.ScreenToWorldPoint(Input.mousePosition);
